...
<body style="background-image : url(<%=request.getContextPath() + "/resource/image" + request.getContextPath() + "/login_background.jpg"%>);background-repeat :no-repeat;background-size:100% 100%; background-attachment: fixed;">
<ft:import src="/system/admin/js/login.js" />
	...
	<div id="infoDiv" class="x-hidden"
		style='color: black; padding-left: 10px; padding-top: 10px; font-size: 12px'>
	<br><br>
	智能工艺知识库系统由四川大学机械工程学院303实验室开发，目前处于系统测试阶段，建议使用Chrome浏览器登陆，初始帐号为ipv6，密码为1，请登陆后及时修改密码，在使用中过程中如果发现任何问题请向开发团队反馈。<br>
	</div>
</body>
</ft:html>